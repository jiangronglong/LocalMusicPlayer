package com.example.localmusicplayer.classes;

/**
 * Created by jiang rong long on 2017/1/12.
 */
...
public class Mp3Info {
    ...
    private String displayName;//名称 4
    private String artist;//歌手名称 2
    private long duration;//时长 1
    private long size;//歌词大小 8
    private String url;//歌词路径 5
